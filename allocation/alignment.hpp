...
namespace alignment {
    ...
    */
    template <
        typename Subjective,
        size_t Alignment = alignof(Subjective),
        size_t Size = sizeof(Subjective)>
    ...
    static inline void
    DeleteAlignedSubject(Referential<Locational<Subjective>> locality)
    {
#ifndef _MSC_VER
#ifndef RAPBTL_NO_STD_CPLUSPLUS
        ::std::
    ...
    template <
        typename Subjective>
    static inline void
    DeleteAlignedSubjectAndSetToNull(Referential<Locational<Subjective>> locality)
    {
