...
namespace stdlib {
    ...
    template <typename Subjective>
    static inline const Locational<Subjective>
    AllocateElementUsingMalloc(Referential<Locational<Subjective>> locality)
    {
    ...
    template <typename Subjective>
    static inline const Locational<Subjective>
    AllocateElementUsingCalloc(Referential<Locational<Subjective>> locality)
    {
    ...
    template <typename Subjective>
    static inline void
    DeleteUsingFree(Referential<Locational<Subjective>> locality)
    {
        free(locality);
    }
    ...
    template <typename Subjective>
    static inline void
    DeleteUsingFreeAndSetToNull(Referential<Locational<Subjective>> locality)
    {
