...
namespace selection {
            ...
            relative_set)
    {
        ...
        static auto&
            DuplicateRelative
            = DuplicateSelection<Relative, RelativePositional, RelativeNatural, Natural, Length, Elemental, Safety>;
        BasicPositional
            base_position;
        RelativePositional
            relative_position;
            ...
            relative_set)
    {
        ...
        static auto&
            DuplicateBase
            = DuplicateSelection<Basic, BasicPositional, BasicNatural, Natural, Length, Elemental, Safety>;
        static auto&
            DuplicateRelative
            = DuplicateSelection<Relative, RelativePositional, RelativeNatural, Natural, Length, Elemental, Safety>;
        BasicPositional
