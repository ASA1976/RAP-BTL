...
namespace collection {
    ...
    template <
        ...
        Natural
            Length,
        typename Elemental,
        Referential<Precedent<Natural, Length, Elemental>>
            Precede,
        Referential<Precedent<Natural, Length, Elemental>>
            Cede,
        Referential<Consequent<Natural, Length, Elemental>>
            Proceed,
        Referential<Assortive<Elemental>>
            Equate,
        Referential<Assortive<Elemental>>
    ...
    template <
        ...
        Natural
            Length,
        typename Elemental,
        Referential<Concessive<Natural, Length, Elemental>>
            Concede,
        Referential<Assortive<Elemental>>
            Equate,
        Referential<Assortive<Elemental>>
            ...
            replacement)
    {
        ...
        if (replacement_position < original_position) {
            const Natural
                delta
                = static_cast<Natural>(original_position - replacement_position);
            if (!Move(write_position, write_position + 1, delta) && Safety)
                return false;
        } else {
            const WritePositional<Elemental>
                first = const_cast<WritePositional<Elemental>>(original_position);
            const Natural
                delta
                = static_cast<Natural>(replacement_position - original_position);
    ...
    template <
        ...
        Natural
            Length,
        typename Elemental,
        Referential<ConjointlyConsequent<Resourceful<Natural, Length, Elemental>, ReadPositional<Elemental>, Basic, BasicPositional, BasicNatural, Elemental>>
            ProceedMany>
    static inline bool
    CollateCollection(
        Referential<Resourceful<Natural, Length, Elemental>>
            ...
            relative_set)
    {
        ...
        static auto&
            CollateRelative
            = CollateSelection<Relative, RelativePositional, RelativeNatural, Natural, Length, Elemental, Precede, Cede, Proceed, Equate, Order, Liner, Safety>;
        ReadPositional<Elemental>
            operand_position;
        BasicPositional
            base_position;
            ...
            relative_set)
    {
        ...
        static auto&
            CollateBase
            = CollateSelection<Basic, BasicPositional, BasicNatural, Natural, Length, Elemental, Precede, Cede, Proceed, Equate, Order, Liner, Safety>;
        static auto&
            CollateRelative
            = CollateSelection<Relative, RelativePositional, RelativeNatural, Natural, Length, Elemental, Precede, Cede, Proceed, Equate, Order, Liner, Safety>;
        ReadPositional<Elemental>
    ...
    template <
        ...
        Referential<Consequent<Natural, Length, Elemental>>
            ProceedOne,
        Referential<ConjointlyConsequent<Resourceful<Natural, Length, Elemental>, ReadPositional<Elemental>, Relative, RelativePositional, RelativeNatural, Elemental>>
            ProceedMany,
        Referential<Assortive<Elemental>>
            Equate,
        Referential<Assortive<Elemental>>
