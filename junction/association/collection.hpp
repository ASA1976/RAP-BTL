        ...
        replacement)
{
    ...
    static_assert(
        ...
        "Natural:  Unsigned integer type required");
#endif
    AssociativelySinglePositional<Correlative, Evaluative> original_position, replacement_position, previous;
    Locational<AssociativelySingleNodal<Correlative, Evaluative>> result;
    Natural extent;
    if (!map.first)
        return false;
...
#endif
    static const Natural Before = 0;
    AssociativelyDoublePositional<Correlative, Evaluative> original_position, replacement_position;
    Locational<AssociativelyDoubleNodal<Correlative, Evaluative>> result;
    Natural extent;
    if (!map.first)
        return false;
