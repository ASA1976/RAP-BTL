...
template <
    ...
    Referential<const Scalar<const SinglyJunctive<Natural, Elemental>, SinglyPositional<Elemental>, Natural, const Elemental>> Scale>
static inline bool
AccreditCollection(
...
template <
    ...
    Referential<Assortive<Elemental>> Equate,
    Referential<Assortive<Elemental>> Order,
    Referential<const Lineal<const DoublyJunctive<Natural, Elemental>, DoublyPositional<Elemental>, Natural, const Elemental>> Liner>
static inline bool
AccreditCollection(
        ...
        value)
{
    ...
    DoublyPositional<Elemental> position;
    if (!set.first)
        return false;
...
template <
    typename Natural,
    typename Elemental,
    Referential<Precedent<SinglyLinked<Elemental>, Natural, Elemental>> Precede,
    Referential<Precedent<SinglyLinked<Elemental>, Natural, Elemental>> Cede,
    Referential<Consequent<SinglyLinked<Elemental>, Natural, Elemental>> Proceed,
    Referential<Assortive<Elemental>> Equate,
    Referential<Assortive<Elemental>> Order,
    Referential<const Scalar<const SinglyJunctive<Natural, Elemental>, SinglyPositional<Elemental>, Natural, const Elemental>> Scale>
static inline bool
        ...
        value)
{
    ...
    static_assert(
        ...
        "Natural:  Unsigned integer type required");
#endif
    SinglyPositional<Elemental> position;
    if (!set.first)
...
template <
    typename Natural,
    typename Elemental,
    Referential<Precedent<DoublyLinked<Elemental>, Natural, Elemental>> Precede,
    Referential<Precedent<DoublyLinked<Elemental>, Natural, Elemental>> Cede,
    Referential<Consequent<DoublyLinked<Elemental>, Natural, Elemental>> Proceed,
    Referential<Assortive<Elemental>> Equate,
    Referential<Assortive<Elemental>> Order,
    Referential<const Lineal<const DoublyJunctive<Natural, Elemental>, DoublyPositional<Elemental>, Natural, const Elemental>> Liner>
static inline bool
...
template <
    typename Natural,
    typename Elemental,
    Referential<Concessive<SinglyLinked<Elemental>, Natural, Elemental>> Concede,
    Referential<Assortive<Elemental>> Equate,
    Referential<Assortive<Elemental>> Order,
    Referential<const Scalar<const SinglyJunctive<Natural, Elemental>, SinglyPositional<Elemental>, Natural, const Elemental>> Scale>
static inline bool
...
template <
    typename Natural,
    typename Elemental,
    Referential<Concessive<DoublyLinked<Elemental>, Natural, Elemental>> Concede,
    Referential<Assortive<Elemental>> Equate,
    Referential<Assortive<Elemental>> Order,
    Referential<const Lineal<const DoublyJunctive<Natural, Elemental>, DoublyPositional<Elemental>, Natural, const Elemental>> Liner>
static inline bool
        ...
        replacement)
{
    ...
    static_assert(
        ...
        "Natural:  Unsigned integer type required");
#endif
    SinglyPositional<Elemental> original_position, replacement_position, previous;
    Locational<SinglyNodal<Elemental>> result;
    Natural extent;
    if (!set.first)
        return false;
...
#endif
    static const Natural Before = 0;
    DoublyPositional<Elemental> original_position, replacement_position;
    Locational<DoublyNodal<Elemental>> result;
    Natural extent;
    if (!set.first)
        return false;
    extent = Account(set) - 1;
        ...
        base)
{
    ...
    static_assert(
        ...
        "Natural:  Unsigned integer type required");
#endif
    SinglyPositional<Elemental> operand_position;
        ...
        base)
{
    ...
    static_assert(
        ...
        "Natural:  Unsigned integer type required");
#endif
    DoublyPositional<Elemental> operand_position;
    BasicPositional base_position;
...
template <
    ...
    typename Natural,
    typename Elemental,
    Referential<ConjointlyConsequent<Junctive<Communicative, Natural, Elemental>, Positional<Communicative, Elemental>, Basic, BasicPositional, BasicNatural, Elemental>> ProceedMany>
static inline bool
CollateCollection(
        ...
        relative_set)
{
    ...
    static auto& CollateRelative = CollateSelection<Relative, RelativePositional, RelativeNatural, Natural, Elemental, Precede, Cede, Proceed, Equate, Order, Scale>;
    SinglyPositional<Elemental> operand_position;
    BasicPositional base_position;
    RelativePositional relative_position;
    BasicNatural base_extent;
    Natural operand_extent;
...
#endif
    using ElementReferential = Referential<const Elemental>;
    static auto& CollateRelative = CollateSelection<Relative, RelativePositional, RelativeNatural, Natural, Elemental, Precede, Cede, Proceed, Equate, Order, Liner>;
    DoublyPositional<Elemental> operand_position;
    BasicPositional base_position;
    RelativePositional relative_position;
    BasicNatural extent;
...
#endif
    using ElementReferential = Referential<const Elemental>;
    static auto& CollateBase = CollateSelection<Basic, BasicPositional, BasicNatural, Natural, Elemental, Precede, Cede, Proceed, Equate, Order, Scale>;
    static auto& CollateRelative = CollateSelection<Relative, RelativePositional, RelativeNatural, Natural, Elemental, Precede, Cede, Proceed, Equate, Order, Scale>;
    SinglyPositional<Elemental> operand_position;
    BasicPositional base_position;
    RelativePositional relative_position;
...
#endif
    using ElementReferential = Referential<const Elemental>;
    static auto& CollateBase = CollateSelection<Basic, BasicPositional, BasicNatural, Natural, Elemental, Precede, Cede, Proceed, Equate, Order, Liner>;
    static auto& CollateRelative = CollateSelection<Relative, RelativePositional, RelativeNatural, Natural, Elemental, Precede, Cede, Proceed, Equate, Order, Liner>;
    DoublyPositional<Elemental> operand_position;
    BasicPositional base_position;
    RelativePositional relative_position;
...
template <
    ...
    typename Natural,
    typename Elemental,
    Referential<Consequent<Communicative, Natural, Elemental>> ProceedOne,
    Referential<ConjointlyConsequent<Junctive<Communicative, Natural, Elemental>, Positional<Communicative, Elemental>, Relative, RelativePositional, RelativeNatural, Elemental>> ProceedMany,
    Referential<Assortive<Elemental>> Equate,
    Referential<Assortive<Elemental>> Order>
static inline bool
...
template <
    ...
    typename Elemental,
    Referential<Consequent<Communicative, Natural, Elemental>> ProceedOne,
    Referential<ConjointlyConsequent<Junctive<Communicative, Natural, Elemental>, Positional<Communicative, Elemental>, Basic, BasicPositional, BasicNatural, Elemental>> ProceedManyFromBase,
    Referential<ConjointlyConsequent<Junctive<Communicative, Natural, Elemental>, Positional<Communicative, Elemental>, Relative, RelativePositional, RelativeNatural, Elemental>> ProceedManyFromRelative,
    Referential<Assortive<Elemental>> Equate,
    Referential<Assortive<Elemental>> Order>
static inline bool
...
template <
    ...
    typename Natural,
    typename Elemental,
    Referential<Consequent<Communicative, Natural, Elemental>> Proceed,
    Referential<Assortive<Elemental>> Equate,
    Referential<Assortive<Elemental>> Order>
static inline bool
