...
namespace consecution {
            ...
            to)
    {
        ...
        static auto&
            SequenceList
            = Sequence<SinglyLinked<Elemental>, Relative, Appositional, RelativeNatural, Natural, Elemental, Adjunct, true>;
        Locational<SinglyNodal<Elemental>>
            first, last, previous;
        Natural
            length;
            ...
            to)
    {
        ...
        static auto&
            CallCede
            = Cede<Relative, Positional, RelativeNatural, Natural, Elemental, Adjunct>;
        if (!rank.at)
            throw rank;
