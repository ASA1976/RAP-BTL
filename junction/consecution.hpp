        ...
        to)
{
    ...
    Locational<Nodal<Connective, Elemental>> first, last, next;
    Natural count;
    current = from;
        ...
        to)
{
    ...
    Locational<SinglyNodal<Elemental>> first, last;
    Natural length;
        ...
        to)
{
    ...
    Locational<DoublyNodal<Elemental>> first, last;
    Natural length;
    if (!SequenceList(sequence, first, last, length, direction, space, from, to))
        return false;
    UnsetPrevious(first);
        ...
        value)
{
    ...
    static_assert(
        ...
        "Natural:  Unsigned integer type required");
#endif
    Locational<SinglyNodal<Elemental>> result, previous;
        ...
        to)
{
    ...
    Locational<SinglyNodal<Elemental>> first, last, previous;
    Natural length;
    previous = sequence.first;
    if (previous == rank.at) {
        if (!SequenceList(sequence, first, last, length, direction, space, from, to))
        ...
        count)
{
    ...
    static_assert(
        ...
        "Natural:  Unsigned integer type required");
#endif
    Locational<DoublyNodal<Elemental>> first;
    Natural index;
    if (count <= 0)
        return false;
    first = rank.at;
        ...
        count)
{
    ...
    static_assert(
        ...
        "Natural:  Unsigned integer type required");
#endif
    Locational<SinglyNodal<Elemental>> last, previous;
    Natural index;
    if (count <= 0)
        return false;
    last = rank.at;
        ...
        count)
{
    ...
    static_assert(
        ...
        "Natural:  Unsigned integer type required");
#endif
    Locational<DoublyNodal<Elemental>> last;
    Natural index;
    if (count <= 0)
        return false;
    last = rank.at;
