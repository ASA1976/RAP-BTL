...
namespace consecution {
            ...
            to)
    {
        ...
        static auto&
            SequenceList
            = Sequence<SinglyLinked<Elemental>, Relative, Appositional, RelativeNatural, Natural, Elemental, Adjunct, Safety>;
        Locational<SinglyNodal<Elemental>>
            first, last;
        Natural
            length;
            ...
            to)
    {
        ...
        static auto&
            SequenceList
            = Sequence<DoublyLinked<Elemental>, Relative, Appositional, RelativeNatural, Natural, Elemental, Adjunct, Safety>;
        Locational<DoublyNodal<Elemental>>
            first, last;
        Natural
            length;
            ...
            to)
    {
        ...
        static auto&
            SequenceList
            = Sequence<SinglyLinked<Elemental>, Relative, Appositional, RelativeNatural, Natural, Elemental, Adjunct, false>;
        Locational<SinglyNodal<Elemental>>
            first, last, previous;
        Natural
            length;
            ...
            to)
    {
        ...
        static auto&
            SequenceList
            = Sequence<DoublyLinked<Elemental>, Relative, Appositional, RelativeNatural, Natural, Elemental, Adjunct, false>;
        Locational<DoublyNodal<Elemental>>
            first, last;
        Natural
            length;
