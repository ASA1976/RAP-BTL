...
#endif
            static auto&
                CallPrecede = Precede< Natural, Elemental, Adjunct >;
...
#endif
            static auto&
                SequenceList = Sequence< SinglyLinked< Elemental >, Relative, Appositional, RelativeNatural, Natural, Elemental, Adjunct, false >;
            Locational< SinglyNodal< Elemental > >
                first, last, previous;
            Natural
                length;
...
#endif
            static auto&
                SequenceList = Sequence< SinglyLinked< Elemental >, Relative, Appositional, RelativeNatural, Natural, Elemental, Adjunct, true >;
            Locational< SinglyNodal< Elemental > >
                first, last, previous;
            Natural
                length;
...
#endif
            static auto&
                SequenceList = Sequence< DoublyLinked< Elemental >, Relative, Appositional, RelativeNatural, Natural, Elemental, Adjunct, false >;
            Locational< DoublyNodal< Elemental > >
                first, last;
            Natural
                length;
...
#endif
            static auto&
                CallPrecede = Precede< Relative, Appositional, RelativeNatural, Natural, Elemental, Adjunct >;
            if (!rank.at || !sequence.first)
                throw rank;
...
#endif
            static auto&
                CallCede = Cede< Natural, Elemental, Adjunct >;
            if (!rank.at)
                throw rank;
...
#endif
            static auto&
                CallCede = Cede< Relative, Positional, RelativeNatural, Natural, Elemental, Adjunct >;
            if (!rank.at)
                throw rank;
...
#endif
            static auto&
                CallCede = Cede< Relative, Appositional, RelativeNatural, Natural, Elemental, Adjunct >;
            if (!rank.at)
                throw rank;
            return CallCede( sequence, rank, direction, space, from, to );
        }
