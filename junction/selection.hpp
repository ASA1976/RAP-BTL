...
namespace selection {
            ...
            relative_set)
    {
        ...
        static auto&
            DuplicateRelative
            = DuplicateSelection<Connective, Relative, RelativePositional, RelativeNatural, Natural, Elemental, Proceed>;
        BasicPositional
            base_position;
        RelativePositional
            relative_position;
            ...
            relative_set)
    {
        ...
        static auto&
            DuplicateBase
            = DuplicateSelection<Connective, Basic, BasicPositional, BasicNatural, Natural, Elemental, Proceed>;
        static auto&
            DuplicateRelative
            = DuplicateSelection<Connective, Relative, RelativePositional, RelativeNatural, Natural, Elemental, Proceed>;
        BasicPositional
