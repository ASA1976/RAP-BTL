...
template <
    ...
    Referential<const Scalar<const Junctive<Connective, Natural, Elemental>, Positional<Connective, Elemental>, Natural, const Elemental>> Scale>
static inline bool
AccreditSelection(
...
template <
    ...
    typename Natural,
    typename Elemental,
    Referential<Consequent<Connective, Natural, Elemental>> Proceed,
    Referential<Assortive<Elemental>> Equate,
    Referential<const Scalar<const Junctive<Connective, Natural, Elemental>, Positional<Connective, Elemental>, Natural, const Elemental>> Scale>
static inline bool
ComposeSelection(
...
template <
    typename Natural,
    typename Elemental,
    Referential<Recessive<SinglyLinked<Elemental>, Natural, Elemental>> Succeed,
    Referential<Assortive<Elemental>> Equate,
        ...
        value)
{
    ...
    Locational<SinglyNodal<Elemental>> previous;
    Natural count;
    if (!set.first)
        return false;
    previous = 0;
...
template <
    ...
    Referential<Assortive<Elemental>> Equate,
    Referential<const Scalar<const DoublyJunctive<Natural, Elemental>, DoublyPositional<Elemental>, Natural, const Elemental>> Scale>
static inline bool
DiscomposeSelection(
...
#endif
    SinglyPositional<Elemental> position;
    Locational<SinglyNodal<Elemental>> previous, found, result;
    if (!set.first)
        return false;
...
#endif
    DoublyPositional<Elemental> position;
    Locational<DoublyNodal<Elemental>> found, result;
    Natural count;
    if (!set.first)
        return false;
    result = found = 0;
...
#endif
    static auto& DuplicateRelative = DuplicateSelection<Connective, Relative, RelativePositional, RelativeNatural, Natural, Elemental, Proceed>;
        ...
        relative_set)
{
    ...
    static_assert(
        ...
        "RelativeNatural:  Unsigned integer type required");
#endif
    static auto& DuplicateBase = DuplicateSelection<Connective, Basic, BasicPositional, BasicNatural, Natural, Elemental, Proceed>;
    static auto& DuplicateRelative = DuplicateSelection<Connective, Relative, RelativePositional, RelativeNatural, Natural, Elemental, Proceed>;
    BasicPositional base_position;
    RelativePositional relative_position;
