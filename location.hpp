...
Locate(Referential<Subjective> subject)
{
    const Positive<Subjective> posit = { &subject };
    return posit;
}
...
Confer(Referential<Subjective> subject)
{
    const Conferential<Subjective> conferment = { subject };
    return conferment;
}
...
Defer(Referential<Subjective> subject)
{
    const Deferent<Subjective> deferment = { subject };
    return deferment;
}
...
Deter(Referential<Subjective> subject)
{
